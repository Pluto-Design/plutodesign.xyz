        ...
        <main className="w-full h-screen flex items-center justify-center flex-col" id="main">
            <section className="flex w-full h-9/10 flex-row">
                <div className="xl:w-2/3 w-full xl:px-32 px-8 flex-col flex justify-center md:items-start">
                    <h1 className="text-3xl lg:text-5xl pt-20 sm:pt-0 font-bold">Professional <span className="text-dark-red">web services</span> for</h1>
                    <h2 className="text-4xl lg:text-5xl font-bold text-dark-red">Your Business</h2>
                    <p className="text-2xl lg:text-4xl font-bold text-dark-red opacity-60 py-2">Design / Development / Hosting</p>
