...
const Portfolio = () => {
    return (
        <section className="w-full h-screen flex flex-col" id="portfolio">
            <p className="text-5xl font-bold mt-8 text-dark-red flex items-center justify-center">Portfolio</p>
            <div className="flex flex-1 lg:px-8 flex-wrap justify-center items-center">
                <PortfolioCard to="/">
                ...
                <PortfolioCard to="/">
                    <div className="w-full h-full flex justify-center hover:opacity-70 transition-all ease-in-out duration-200 rounded-xl bg-dark-red items-center">
                        <p className="text-5xl text-center text-white font-bold">See all Projects</p>
                    </div>
                </PortfolioCard>
            </div>
        </section>
