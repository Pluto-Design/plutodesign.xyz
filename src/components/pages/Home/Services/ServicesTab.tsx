...
const ServicesTab = () => {
    return (
        <section className="bg-dark-red w-full lg:h-[28rem] flex flex-col items-center justify-center" id="services">
            <p className="text-4xl h-1/5 font-bold my-4 text-white flex items-center justify-center">Services</p>
