...
const OfferCard = ({ title, price, offers }: CardProps) => {
    return (
        <div className="w-11/12 md:w-2/5 lg:w-1/5 lg:my-0 my-8 max-h-screen flex flex-col">
            ...
            <div className="py-3 flex items-center justify-center hover:scale-105 transition-all ease-in-out duration-200 cursor-pointer mt-4 w-full rounded-xl bg-darken-white">
